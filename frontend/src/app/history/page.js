 ...
 * history/page.js
 * ───────────────
 * Scan history dashboard page for NeuroDL v2.0.
 *
 * Route: /history
 * Wraps HistoryTable with a page header, stats summary,
 * and a back link to the main analysis page.
 */
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                ...
                >
                  Every MRI analysis is automatically saved here with its
                  AI report, confidence score, and visual outputs.
                </p>
              </div>

              {/* Analyse new scan CTA */}
              <Link
                href="/#analyze"
        ...
        <div className="container">
          <div className="max-w-6xl mx-auto">
            <div className="alert alert-warning">
              ...
              <div>
                <p style={{ fontWeight: 700, marginBottom: 2, fontSize: "0.9rem" }}>
                  Data & Privacy Notice
                </p>
                <p style={{ margin: 0, fontSize: "0.82rem", lineHeight: 1.5 }}>
                  ...
                  AI reports are generated locally via Ollama and are for
