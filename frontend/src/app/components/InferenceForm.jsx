 ...
 * InferenceForm.jsx
 * ─────────────────
 * Orchestrates the two-step diagnosis flow:
 *
 ...
 * State:
 *   step        : 1 | 2
 *   patientId   : int  — returned from /patients
 *   patientName : string — shown in Step 2 header
 */
    ...
    <div className="space-y-8">
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 6 }}>
          ...
          <span
            style={{
              fontSize:   "0.75rem",
              fontWeight: 600,
              color:      step >= 1 ? "var(--color-primary)" : "var(--color-text-light)",
            }}
          >
            Patient Details
          </span>
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 6 }}>
          ...
          <span
            style={{
              fontSize:   "0.75rem",
              fontWeight: 600,
              color:      step === 2 ? "var(--color-primary)" : "var(--color-text-light)",
            }}
          >
            MRI Upload
          </span>
      ...
      {step === 2 && (
        <div className="fade-in">
          ...
          {/* MRI uploader — passes patient_id down */}
